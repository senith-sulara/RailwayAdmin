package com.example.trainadmin;
        ...
        import com.example.trainadmin.models.UserModel;
...
public class UserD extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        msg.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(UserD.this, CustomerDetails.class);
                intent.putExtra("userKey", userKey);
                finish();
                startActivity(intent);
            }
        ...
        if (currentUser.getUid() != null) {
            ...
            DatabaseReference userDetailsRef = FirebaseDatabase.getInstance().getReference("users").child(currentUser.getUid()).child("UserDetails");
            userDetailsRef.addListenerForSingleValueEvent(new ValueEventListener() {
                ...
                public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                    if (dataSnapshot.exists()) {
                        ...
                        Toast.makeText(UserD.this, "User data not found", Toast.LENGTH_SHORT).show();
                    }
                }
    ...
    private void addUserToDatabase(String name, String email, String tel, String address, String gender) {
        ...
        if (currentUser.getUid() != null) {
            ...
            DatabaseReference userDetailsRef = database.getReference("users").child(currentUser.getUid()).child("UserDetails");
...
//            }
            ...
            Toast.makeText(UserD.this, "User Id is null", Toast.LENGTH_SHORT).show();
        }
    }
